...
public interface TicketRepository extends JpaRepository<Ticket,Long> {
    ...
    List<Ticket> findAllByLocalDateTimeBetween(LocalDateTime dateTime1, LocalDateTime dateTime2);
    ...
    @Query("SELECT t FROM Ticket t WHERE t.localDateTime BETWEEN ?1 AND ?2")
